...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '中文版页面 ID,en:英文版页面 ID',
  THEME: process.env.NEXT_PUBLIC_THEME || 'default', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '零一星火', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '企业家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zeroonespark.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '零一星火, 文库', // 网站关键词 英文逗号隔开

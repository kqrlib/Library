...
const SearchInput = ({ currentTag, keyword, cRef }) => {
  ...
  return <div className='flex w-full bg-gray-100 rounded-md shadow-sm'
              data-aos="fade-down"
        ...
        <input
            ...
            className={'outline-none w-full text-sm pl-4 transition focus:shadow-sm rounded-md font-light leading-10 text-black bg-gray-100 dark:bg-gray-800 dark:text-white'}
            onKeyUp={handleKeyUp}
            onFocus={handleFocus}

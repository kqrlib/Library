          ...
          <div className="space-x-3 mr-4">
            ...
            {post?.category && (
              <span>
                ...
                <a href={`/category/${post?.category}`} className="hover:text-red-400 transition-all duration-200">
                  {post?.category}
                </a>
              </span>
            )}
            {post?.tags &&
              ...
              post?.tags.map((t) => (
                <span key={t}>
                  ...
                  /{" "}
                  <Link href={`/tag/${t}`}>
                    <span className=" hover:text-red-400 transition-all duration-200">{t}</span>
                  </Link>
                </span>
              ))}
          </div>
